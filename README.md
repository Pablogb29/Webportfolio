...
My personal website, built with [Next.js](https://nextjs.org/), [Tailwind CSS](https://tailwindcss.com/), [Upstash](https://upstash.com?ref=chronark.com), [Contentlayer](https://www.contentlayer.dev/) and deployed to [Vercel](https://vercel.com/).Inspired in https://chronark.com 
...
```sh-session
git clone https://github.com/Pablogb29/Webportfolio.git
cd Webportfolio
```
Create a `.env` 
